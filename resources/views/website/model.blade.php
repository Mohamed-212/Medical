                    ...
                    <div class="cv-blog-single-box row">
                            ...
                            <div class="carousel-indicators">
                                @foreach($model->getImages as $index => $image)
                                    <button type="button" data-bs-target="#carouselExampleIndicators"
                                            data-bs-slide-to="{{$index}}" @if($index == 0) class="active"
                                            aria-current="true" @endif aria-label="Slide {{$index+1}}"></button>
                                @endforeach
                            </div>
                            <div class="carousel-inner">
                                @foreach($model->getImages as $index => $image)
                                    <div class="carousel-item @if($index == 0) active @endif ">
                                        <img src="{{$image->image_path}}" style="height: 350px" class="d-block m-auto"
                                             alt="image">
                                    </div>
                                @endforeach
                            </div>
                        ...
                        <div class="cv-blog-data col-md-7">
                            ...
                            <table class="w-100">
                                ...
                                <tr>
                                    <th>@lang('general.condition')</th>
                                    <td>@lang('general.'.$model->condition)</td>
                                </tr>
                                <tr>
                                    <th>@lang('general.availability')</th>
                                    <td>@lang('general.'.$model->availability)</td>
                                </tr>
                                </tbody>
                                <tfoot>
                                <tr>
                        ...
                        <div class="col-12 p-0 mt-4 mb-4">
                            <div class="product-tabs">
                                <ul>
                                    <li id="tab_description_tabbed" class=" active first float-start"
                                        style="border-top: 5px solid #3cbcff;">
                                        <a class="text-dark fw-bold">@lang('general.specification')</a></li>
                                </ul>
                                <div class="clearfix"></div>
                                <div class="tab-content p-4 rounded-1" id="tab_description_tabbed_contents">
                                    <div>
                                        {!! $model->description !!}
                                    </div>
                                </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="cv-product-box">
                                            <div class="cv-product-img">
                                                <img src="{{$model->getImages[0]['image_path']}}" style="height: 250px"
                                                     alt="image" class="img-fluid"/>
                                                <div class="cv-product-button">
                                                    <a href="{{route('website.models.show', $model->id)}}"
                                                       class="cv-btn">
                                            ...
                                            <div class="cv-product-data">
                                                <a href="{{route('website.models.show', $model->id)}}"
                                                   class="cv-price-title">{{$model->name}}</a>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
