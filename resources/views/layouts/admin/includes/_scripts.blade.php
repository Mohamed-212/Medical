...
<script src="{{asset('assets/admin-assets/plugins/jqvmap/maps/jquery.vmap.usa.js')}}"></script>
<!-- jQuery Knob Chart -->
...
<script>
    var dataTablesLanguageLink = "{{asset('assets/admin-assets/plugins/datatables/lang/'. app()->getLocale() .'.json')}}"
</script>
