        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="cv-foot-box cv-foot-contact">
                    ...
                    <p><span>@lang('general.phone') : </span>{{config('website.setup')['mobile']['value']}}</p>
                    <p><span>@lang('general.email') : </span>{{config('website.setup')['email']['value']}}</p>
                    <p><span>@lang('general.address') : </span>{{config('website.setup')['address_'.app()->getLocale()]['value']}}</p>
