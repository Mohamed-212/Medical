...
{{--                                    <p>{{$branch['address']}}</p>--}}
            ...
            <div class="col-lg-4 col-md-6">
                <div class="cv-foot-box cv-foot-contact">
                    ...
                    <p><span>@lang('general.phone') : </span>{{\App\Helper\Helper::setup()['mobile']['value']}}</p>
                    <p><span>@lang('general.email') : </span>{{\App\Helper\Helper::setup()['email']['value']}}</p>
                    <p><span>@lang('general.address') : </span>{{\App\Helper\Helper::setup()['address_'.app()->getLocale()]['value']}}</p>
                    <ul class="cv-foot-social">
                        <li><a href="{{\App\Helper\Helper::setup()['facebook']['value']}}">
                        ...
                        <li><a href="{{\App\Helper\Helper::setup()['twitter']['value']}}">
