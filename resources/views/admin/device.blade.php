    ...
    <div class="content-wrapper">
        ...
        @include('layouts.admin.includes._breadcrumb',
            ['title' => __('dashboard.devices'),
             'current_page' => __('dashboard.devices'),
              'prev_pages' => [
                                    ...
                                    <table id="example1" class="table table-bordered table-hover table-striped">
                                        ...
                                        @foreach($devices as $index => $device)
                                            <tr>
                                                ...
                                                <td>{{$device->name}}</td>
                                                <td>
                                                    <a href="{{route('admin.devices.show', $device->id)}}" class="btn btn-info"><i class="fas fa-eye"></i></a>
                                                    <a href="{{route('admin.devices.edit', $device->id)}}" class="btn btn-success"><i class="fas fa-edit"></i></a>
                                                    {!! Form::open(['route' => ['admin.devices.destroy', $device->id], 'method' => 'delete', 'class' => 'd-inline-block']) !!}
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {!! Form::open(['route' => 'admin.devices.store', 'method' => 'post', 'id' => 'create_form']) !!}
                    <div class="form-group">
                        {!! Html::decode(Form::label(null, __('dashboard.name_ar') . ' <span class="text-bold text-danger">*</span>')) !!}
                        {!! Form::text('name_ar', null, ['class' => 'form-control', 'placeholder' => __('dashboard.name_ar'), 'required' => true]) !!}
                        @error('name_ar')
                    ...
                    <div class="form-group">
                        {!! Html::decode(Form::label(null, __('dashboard.name_en') . ' <span class="text-bold text-danger">*</span>')) !!}
                        {!! Form::text('name_en', null, ['class' => 'form-control', 'placeholder' => __('dashboard.name_en'), 'required' => true]) !!}
                        @error('name_en')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
...
@push('scripts')
    ...
    <script>
        $(function () {
            @if($errors && ($errors->has('name_ar') || $errors->has('name_en')))
